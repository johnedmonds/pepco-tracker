...
public class TestOutageArea extends TestCase {
    ...
    /**
     * Make sure Hibernate loads the OutageAreaRevisions relation for ParserRun and its inverse.
     */
    ...
    /**
     * Testing OutageAreaRevision.compareTo.
     */
    public void testComparison() {
	assertTrue(new OutageAreaRevision(0, null, 0, new ParserRun(
		new Timestamp(1), new Timestamp(1))).compareTo(new OutageAreaRevision(0, null, 0,
		new ParserRun(new Timestamp(2), new Timestamp(2)))) < 0);

	assertTrue(new OutageAreaRevision(0, null, 0, new ParserRun(
		new Timestamp(2), new Timestamp(2))).compareTo(new OutageAreaRevision(0, null, 0,
	...
	assertTrue(new OutageAreaRevision(0, null, 0, new ParserRun(
		new Timestamp(1), new Timestamp(1))).compareTo(new OutageAreaRevision(1, null, 0,
		new ParserRun(new Timestamp(1), new Timestamp(1)))) < 0);
	...
	assertTrue(new OutageAreaRevision(0, null, 0, new ParserRun(
		new Timestamp(8589934592L), new Timestamp(8589934592L))).compareTo(new OutageAreaRevision(
		0, null, 0, new ParserRun(new Timestamp(8589934592L), new Timestamp(8589934592L)))) == 0);

	assertTrue(new OutageAreaRevision(0, null, 0, new ParserRun(
		new Timestamp(8589934592L), new Timestamp(8589934592L))).compareTo(new OutageAreaRevision(
		0, null, 0, new ParserRun(new Timestamp(17179869184L), new Timestamp(17179869184L)))) < 0);

	assertTrue(new OutageAreaRevision(0, null, 0, new ParserRun(
		new Timestamp(17179869184L), new Timestamp(17179869184L))).compareTo(new OutageAreaRevision(
		0, null, 0, new ParserRun(new Timestamp(8589934592L), new Timestamp(8589934592L)))) > 0);

	assertTrue(new OutageAreaRevision(0, null, 0, new ParserRun(
		new Timestamp(8589934592L), new Timestamp(8589934592L))).compareTo(new OutageAreaRevision(
		1, null, 0, new ParserRun(new Timestamp(8589934592L), new Timestamp(8589934592L)))) < 0);
